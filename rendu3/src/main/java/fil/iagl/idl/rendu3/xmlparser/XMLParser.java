...
public class XMLParser {
	...
	public static void readSurefireReport(File sureFireReportFolder) throws SAXException, IOException, ParserConfigurationException {
	    ...
	    for (File report : reports) {
	      ...
	      if (testsuiteNode.item(0).getNodeType() == Node.ELEMENT_NODE) {
	        ...
	        System.out.printf("%s\tSuccess :%d\tFailure : %d\n", className, nbSuccess, nbError + nbFailure + nbSkipped);
	      }
	    }
	  }
